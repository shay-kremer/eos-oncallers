...
vi.mock('../src/utils/database', () => {
  const mockPrisma = {
    ...
    incident: { findMany: vi.fn(), findUnique: vi.fn(), create: vi.fn(), update: vi.fn() },
    ...
    schedule: { findMany: vi.fn(), findUnique: vi.fn(), create: vi.fn() },
    scheduleLayer: { create: vi.fn(), findUnique: vi.fn() },
    scheduleMember: { create: vi.fn() },
    scheduleOverride: { create: vi.fn(), findFirst: vi.fn() },
    escalationPolicy: { findMany: vi.fn(), findUnique: vi.fn(), create: vi.fn(), delete: vi.fn() },
    notificationRule: { findMany: vi.fn() },
    serviceIntegration: { findUnique: vi.fn() },
